...
function UploadToFTPServer($source, $destination) {
    // CONNECT TO FTP SERVER
    $ftp = ftp_connect(FTP_HOST) or die("Failed to connect to " . FTP_HOST);

    // LOGIN
    if (ftp_login($ftp, FTP_USER, FTP_PASSWORD)) {
        // $source = "C:/Users/legutsmann/Desktop/test.txt";
        // $destination = ""; // Generate Filename + take fileextension from upload / allowed filetype
